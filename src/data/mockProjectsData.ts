...
export const projects: Project[] = [
  {
    ...
    progress: 62,
    priority: "high",
    agent: { emoji: "\u{1F527}", name: "Charlie", color: "#30D158" },
    ...
    phases: [
      ...
      },
      {
        ...
        handoffToAgentId: "codex",
        dependsOnPhaseIds: ["monitoring-foundation"],
      },
    ],
  },
  {
    ...
    description:
      "Central dashboard for the agent organization. Tasks, projects, approvals, agent activity, docs, and real-time monitoring.",
    status: "active",
    progress: 71,
    priority: "high",
    agent: { emoji: "\u{1F454}", name: "Henry", color: "#FFD700" },
    ...
    phases: [
      {
        ...
        dependsOnPhaseIds: [],
        latestRun: {
          id: "phase-mission-control-envelope",
          kind: "agent_packet",
          ...
          deliverable: "Inspector flow and review envelope are wired and ready for approval.",
          text: "Waiting on Henry review before Ralph sign-off.",
          agentId: "codex",
          agentName: "Codex",
          ...
          fields: {
            status: "needs_review",
            focus: "Review packet contract and inspector workflow",
            next: "Approve or send back with explicit rework notes.",
            blockers: "Need reviewer confirmation on scope and handoff.",
      ...
      },
      {
        ...
        ownerAgentId: "ralph",
        reviewerAgentId: "henry",
        dependsOnPhaseIds: ["execution-envelope"],
      },
    ],
  },
  {
    ...
    description:
      '"Ask Alex" Chrome extension for Vibely Academy. RAG pipeline over course content with personalized responses.',
    status: "active",
    progress: 25,
    priority: "high",
    agent: { emoji: "\u{1F454}", name: "Henry", color: "#FFD700" },
  ...
  },
  {
    ...
    description:
      "Violet's opportunity engine - research market gaps, validate ideas, and build small SaaS products autonomously.",
    status: "planning",
    progress: 15,
    priority: "medium",
    agent: { emoji: "\u{1F52E}", name: "Violet", color: "#BF5AF2" },
    updatedAgo: "8 days ago",
    updatedBy: "Violet",
    ownerAgentId: "violet",
  ...
  },
  {
    ...
    description:
      "Smart glasses bridge app connecting Even Realities G2 glasses to Henry via BLE. AI assistant in your glasses.",
    status: "planning",
    progress: 0,
    priority: "medium",
